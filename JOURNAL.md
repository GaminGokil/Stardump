...
- **Orchestrator:** Claude Sonnet 4.6 (Anthropic) — designed the implementation plan (`docs/PLAN.md`), reviewed each diff before committing, and managed the subagent build pipeline.
